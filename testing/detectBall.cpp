...
int main(int argc, char **argv){
    ...
    //blue
    // inRange(src_gray, Scalar(120,0,0), Scalar(130,255,255), processed);
    // Canny(processed, blue, 100, 100*3,5);

    // //pink
    // inRange(src_gray, Scalar( 155,0,0), Scalar(165,255,255), processed);
    // Canny(processed, pink, 100, 100*3,5);
    // bitwise_or(pink, blue, temp);

    //white
    // inRange(src_gray, Scalar(0,0,200), Scalar(255,50,255), processed);
    // inRange(src_gray, Scalar(5,0,255), Scalar(185,175,255), processed);
    Canny(processed, white, 100, 100*3,5);
    bitwise_or(processed, white, temp);

    // //red
    // inRange(src_gray, Scalar(0,150,150), Scalar(10,255,255), processed);
    // Canny(processed, red, 100, 100*3,5);
    // bitwise_or(temp, red, temp);

    // //black
    // inRange(src_gray, Scalar(0,0,0), Scalar(255,255,50), processed);
    // Canny(processed, black, 100, 100*3,5);
    // bitwise_or(temp, black, temp);

    // //yellow
    // inRange(src_gray, Scalar(25,150,140), Scalar(35,255,255), processed);
    // Canny(processed, yellow, 100, 100*3,5);
    // bitwise_or(temp, yellow, temp);
    // 
    // //brown
    // inRange(src_gray, Scalar(10,160,140), Scalar(20,220,200), processed);
